...
def get_unified_tags(posts_with_metadata) : 
    ...
    4. The output json keys are always in small letters and Values are title case convention. 
...
def extract_metadata(post) : 
    ...
    3. tags is an array of text tags. Extract maximum two tags. Make sure the tags are always in small letters. 
